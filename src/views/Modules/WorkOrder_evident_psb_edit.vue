...
import { showLoading, confirmDelete, successCreate, successEdit, failedEdit } from '@/stores/swal'
import { adminTeknis_UpdateDataImage , adminTeknis_GetDataById } from '@/stores/functionAPI'
      ...
      <div class="flex flex-col gap-9">
        ...
        <DefaultCard cardTitle="Input Images">
          <div class="grid grid-cols-2" v-if="savedData">
            ...
            <div class="flex border flex-col items-center p-2 justify-end"> 
              <imageWithPreview label="Start" v-model="savedData.Tr_teknis_evident_marking_dc_start" 
                @update:file="file => savedData.Tr_teknis_evident_marking_dc_start = file" />
            </div>
            <div class="flex border flex-col items-center p-2 justify-end"> 
              <imageWithPreview label="End" v-model="savedData.Tr_teknis_evident_marking_dc_end" 
