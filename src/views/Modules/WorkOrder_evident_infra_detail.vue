            ...
            <div class="col-span-3 grid grid-cols-2">
              ...
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  ...
                  v-model="savedData.Tr_teknis_images.Tr_teknis_redaman_sebelum"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_redaman_sebelum = file)
                  "
                />
              </div>
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  disabled
                  label="Kendala 1"
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_kendala_1"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_kendala_1 = file)
                  "
                />
              </div>
            </div>
            ...
            <div class="col-span-3 grid grid-cols-2">
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  disabled
                  label="Kendala 2"
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_kendala_2"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_kendala_2 = file)
                  "
                />
              </div>
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  disabled
                  label="Kendala 3"
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_kendala_3"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_kendala_3 = file)
                  "
                />
              </div>
            </div>
            ...
            <div class="col-span-3 grid grid-cols-1">
              ...
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  ...
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_proses_sambung"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_proses_sambung = file)
                  "
                />
              </div>
            </div>
            ...
            <div class="col-span-3 grid grid-cols-3">
              ...
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  ...
                  v-model="savedData.Tr_teknis_images.Tr_teknis_redaman_sesudah"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_redaman_sesudah = file)
                  "
                />
              </div>
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  ...
                  v-model="savedData.Tr_teknis_images.Tr_teknis_redaman_out_odp"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_redaman_out_odp = file)
                  "
                />
              </div>
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  ...
                  v-model="savedData.Tr_teknis_images.Tr_teknis_redaman_pelanggan"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_redaman_pelanggan = file)
                  "
                />
              </div>
            </div>
            ...
            <div class="col-span-3 grid grid-cols-2">
              ...
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  disabled
                  label="Start"
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_marking_dc_start"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_marking_dc_start = file)
                  "
                />
              </div>
              <div class="flex border flex-col items-center p-2 justify-end">
                <imageWithPreview
                  disabled
                  label="End"
                  v-model="savedData.Tr_teknis_images.Tr_teknis_evident_marking_dc_end"
                  @update:file="
                    (file) =>
                      (savedData.Tr_teknis_images.Tr_teknis_evident_marking_dc_end = file)
                  "
                />
              </div>
            </div>
