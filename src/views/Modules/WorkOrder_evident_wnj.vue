          ...
          <tr v-for="(item, index) in paginatedData" :key="index" class="border">  
           ...
           <td class="py-1 px-4">  
            <div class="flex items-center space-x-3.5 d-flex justify-center">  
              <router-link class="hover:text-primary" :to="'/modules/work-order/evident/wnj/detail/' + item.Tr_teknis_logistik_id + '/' + item._id">  
               <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">  
                <path :d="mdiEyeOutline" fill="" />  
               </svg>  
              </router-link>  
              <router-link class="hover:text-primary" :to="'/modules/work-order/evident/wnj/edit/' + item.Tr_teknis_logistik_id + '/' + item._id">  
               <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">  
